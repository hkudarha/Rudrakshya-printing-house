      ...
      <div className="mx-auto   py-5">
        <div className="md:flex md:justify-between px-14">
          <div className="mb-6 md:mb-0 ">
            <h2 className="text-[2vw] text-start mb-4 font-bold text-[#fd8500]">
              Basic<span className="text-black">Store</span>
              <span className="text-[#fd8500]">.</span>
            </h2>
            <p className="lg:w-[25vw] sm:[100vw] text-start">
          ...
          <div className="text-start text-sm mb-5">
            ...
            <p>
              If you need support? Just <br /> give use a call.
            </p>
        ...
        <div className="sm:flex sm:items-center sm:justify-between px-14">
