...
>
  ...
  <div className="p-6 rounded-lg text-center relative z-10">
    ...
    <div className="mt-4 inline-flex flex-col md:flex-row items-center bg-white max-w-max rounded-md overflow-hidden">
  <input
    type="email"
    placeholder="Your email address here"
    className="w-auto md:w-64 p-2 bg-white text-black focus:outline-none" // w-auto added
  />
  <button className="bg-[#fd8500] text-white px-6 py-2 uppercase whitespace-nowrap">
    Subscribe
  </button>
</div>
  </div>
